...
def sample_vpr():
    ...
    class MockVPR:
        ...
        differentiators: list = field(
            default_factory=lambda: [
                "Architected scalable solutions at Tech Start",
            ]
        )
        talking_points: list = field(
            default_factory=lambda: [
...
class TestValidateImmutableFacts:
    ...
    def test_valid_cv_returns_no_violations(
        self, sample_baseline, matching_generated_cv
    ):
    ...
    def test_modified_name_returns_violation(
        self, sample_baseline, modified_generated_cv
    ):
    ...
    def test_modified_email_returns_violation(
        self, sample_baseline, modified_generated_cv
    ):
    ...
    def test_modified_phone_returns_violation(
        self, sample_baseline, modified_generated_cv
    ):
    ...
    def test_modified_role_returns_violation(
        self, sample_baseline, modified_generated_cv
    ):
    ...
    def test_modified_dates_returns_violation(
        self, sample_baseline, modified_generated_cv
    ):
    ...
    def test_modified_degree_returns_violation(
        self, sample_baseline, modified_generated_cv
    ):
...
class TestValidateVerifiableSkills:
    ...
    def test_valid_skills_returns_no_violations(
        self, sample_baseline, matching_generated_cv
    ):
...
class TestValidateCVAgainstBaseline:
    ...
    def test_valid_cv_returns_success_result(
        self, sample_baseline, matching_generated_cv
    ):
    ...
    def test_invalid_cv_returns_failure_result(
        self, sample_baseline, modified_generated_cv
    ):
    ...
    def test_result_contains_validation_data(
        self, sample_baseline, matching_generated_cv
    ):
