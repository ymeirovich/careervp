...
from careervp.handlers.models.dynamic_configuration import MyConfiguration
from careervp.handlers.models.env_vars import MyHandlerEnvVars
from careervp.handlers.utils.dynamic_configuration import parse_configuration
from careervp.handlers.utils.observability import logger, metrics, tracer
from careervp.handlers.utils.rest_api_resolver import ORDERS_PATH, app
from careervp.logic.create_order import create_order
from careervp.models.input import CreateOrderRequest
from careervp.models.output import CreateOrderOutput, InternalServerErrorOutput
...
def handle_create_order(
    create_input: Annotated[
        CreateOrderRequest, Body(embed=False, media_type="application/json")
    ],
) -> CreateOrderOutput:
    ...
    logger.debug(
        "fetched dynamic configuration", configuration=my_configuration.model_dump()
    )
