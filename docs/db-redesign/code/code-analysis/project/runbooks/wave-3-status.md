...
| 3.2-RED | D-H4, P-01 | not started (prompt filled in 2026-07-27; blocked on 3.2-SPEC) | — | — | — |
| 3.2-GREEN | D-H4, P-01 | not started (prompt filled in 2026-07-27; blocked on 3.2-RED). Deliberately **`opus/high`, not `fable/high`** — `redesign-execution-plan.md` row 3.2 says `opus/high` and rule 15 copies it verbatim; re-routing it is a rule-8 edit to the plan, not a fill-in decision. | — | — | — |
