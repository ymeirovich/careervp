...
class ResultCode:
    ...
    INTERVIEW_PREP_NOT_FOUND = 'INTERVIEW_PREP_NOT_FOUND'
    FORBIDDEN = 'FORBIDDEN'
    ...
    DYNAMODB_CONDITION_CHECK_FAILED = 'DYNAMODB_CONDITION_CHECK_FAILED'
    DYNAMODB_ERROR = 'DYNAMODB_ERROR'
    DYNAMODB_VALIDATION_EXCEPTION = 'DYNAMODB_VALIDATION_EXCEPTION'
