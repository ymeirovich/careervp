...
class TestApplicationStateTransitionsInGapHandler:
    ...
    def test_application_state_transitions_to_pending_after_charge(
        self, mock_dal, mock_llm_client, mock_trial_service, mock_app_repo
    ):
